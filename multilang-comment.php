		...
		<form method="post" action="options.php">
			...
			<table class="form-table">
				...
				<tr valign="top">
					...
					<td>
						<label><input name="brtcmt_options[lang_select]" type="radio" value="hi" <?php checked('hi', $options['lang_select']); ?> /> Hindi </label><br />

						<label><input name="brtcmt_options[lang_select]" type="radio" value="en" <?php checked('en', $options['lang_select']); ?> /> English </label><br />
					</td>
				</tr>
...
function brtcmt_comment_switch() {
	$options = get_option('brtcmt_options');
...
function brtcmt_comment_switch_hook() {
	add_action('comment_form_top', 'brtcmt_comment_switch');
}

// Call the Transliteration control function
brtcmt_comment_switch_hook();
